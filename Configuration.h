...
#define CONFIG_EXAMPLES_DIR "delta/ROSTOCK/MAXV2"

/**
 * Choose your version:
 */
// normal size or plus?
#define ROSTOCK_MAX_V2

// ROSTOCK Probe version 1 or 2 see README.md; 0 for no probe
#define ROSTOCK_PROBE_VERSION 1

// Heated Bed:
// 0 ... no heated bed
// 1 ... aluminium heated bed with "BuildTak-like" sticker
// 2 ... ultrabase heated bed
#define ROSTOCK_MAX_ENABLE_BED 1
 ...
 *
 * http://www.lpomykal.cz/3d-printers/MAX/
...
#define STRING_CONFIG_H_AUTHOR "@rafski, @brandstaetter, @grbd" // Who made the changes.
...
#define TEMP_BED_HYSTERESIS          9  // (°C) Temperature proximity considered "close enough" to the target
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Rostock Max - run 'M106 S255' & 'M303 E0 C10 S200'
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_SMOOTH_ROD_OFFSET 204.5   // (mm)
    ...
    #define DELTA_RADIUS 270.0          // (mm) Get this value from G33 auto calibrate
  ...
  #define DELTA_HEIGHT 356.00             // (mm) Get this value from G33 auto calibrate
...
#define Z_MIN_ENDSTOP_INVERTING false //(ROSTOCK_PROBE_VERSION + 0 == 1) // V1 is NO, V2 is NC
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 96 }  // default steps per unit for MAX (GT2, 20 tooth)

//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 760*1.1 }  // default steps per unit for Kossel (GT2, 20 tooth)
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 106.666, 106.666, 106.666, 500 }
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.333, 53.333, 53.333, 500 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.000, 80.000, 80.000, 92.4}  // default steps per unit for rostockmax with 20 tooth pulleys and 1/16 stepping ~ RAAMBo 1.1 and later
...
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 80 }
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 3000, 3000 } // ...or, set your own edit limits
#endif
...
/**
 * Allen key retractable z-probe as seen on many MAX delta printers - https://reprap.org/wiki/MAX#Automatic_bed_leveling_probe
 ...
 *     O-- FRONT --+
 */
#if ROSTOCK_PROBE_VERSION == 2
  #define NOZZLE_TO_PROBE_OFFSET { 22, 19.5, -1 }
#elif ROSTOCK_PROBE_VERSION == 1
  #define NOZZLE_TO_PROBE_OFFSET { 22, 19.5, -1 }
#else
  #define NOZZLE_TO_PROBE_OFFSET { 22, 19.5, -1 }
#endif
...
//odstep pomiedy punktami probkowania a brzegami powierzchni drukowania , margines
...
//
// Touch-screen LCD for Rostock printers
//
//#define ROSTOCK_LCD_I3MEGA
//#define ROSTOCK_LCD_CHIRON
#if EITHER(ROSTOCK_LCD_I3MEGA, ROSTOCK_LCD_CHIRON)
  #define LCD_SERIAL_PORT 3  // Default is 3 for ROSTOCK
  //#define ROSTOCK_LCD_DEBUG
#endif
...
//
// 480x320, 3.5", FSMC Stock Display from ROSTOCK
//
//#define ROSTOCK_TFT35
